...
DELETE
"""
from .control import GPropertyControl
from ..keywords import const, consts
from ..typehint import *


# noinspection PyUnusedLocal
class Anchors(GPropertyControl):
    fill: TConstable[TUid]
    
    center: TConstable[TUid]
    horizontal_center: TConstable[TUid]
    vertical_center: TConstable[TUid]
    
    left: TConstable[TUid]
    right: TConstable[TUid]
    top: TConstable[TUid]
    bottom: TConstable[TUid]
...
class DialectAnchors(Anchors):
    lcenter: TConstable[TUid]
    rcenter: TConstable[TUid]
    tcenter: TConstable[TUid]
    bcenter: TConstable[TUid]
    hcenter: TConstable[TUid]
    vcenter: TConstable[TUid]
    
    lside: TConstable[TUid]
    rside: TConstable[TUid]
    tside: TConstable[TUid]
    bside: TConstable[TUid]
    hside: TConstable[TUid]
    vside: TConstable[TUid]
