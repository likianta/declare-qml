...
from pyml_rc.pyml_dsl.core.composer.ast import SourceAst
from pyml_rc.pyml_dsl.core.composer.pyml_interp import PymlInterpreter
from pyml_rc.pyml_dsl.core.composer.composer import ComponentComposer, PlainComposer
...
def optimize_source_code(source_code: str) -> str:
    ...
    :return:
    """
    from pyml_rc.pyml_dsl.core.composer.mask import Mask
