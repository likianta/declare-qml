...
def main():
    ...
    Inputs:
        ...
        ../resources/no6_all_pyml_widgets.json
            this is generated by `../qml_modules_indexing/
            no4_all_pyml_widgets.py`
    
    Outputs:
        ../../declare_qml/widgets/{*package}: for product
        ../../tests/widgets/{*package}: for test
        
    Requires:
        make sure we have run `create_package_dirs` for once before using this
        function.
    """
    template: str = loads('../resources/template.txt')
    #   template keywords see `../resources/template.txt:docs:placeholders`
    
    data_r: TDataNo6 = loads('../resources/no6_all_pyml_widgets.json')
...
def create_package_dirs(file='../resources/no6_all_pyml_widgets.json'):
    ...
    home_dir = abspath('../../tests/widgets')  # A (test)
